...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href="http://localhost:8080/tables/ejercicio3.php?movie_id=$movie_id&order=review_date&parametro=$parametro">Date</a></th>
    <th style="width: 10em;"><a href="http://localhost:8080/tables/ejercicio3.php?movie_id=$movie_id&order=reviewer_name&parametro=$parametro">Reviewer</a></th>
     <th><a href="http://localhost:8080/tables/ejercicio3.php?movie_id=$movie_id&order=review_comment&parametro=$parametro">Comments</a></th>
     <th style="width: 5em;"><a href="http://localhost:8080/tables/ejercicio3.php?movie_id=$movie_id&order=review_rating&parametro=$parametro">Rating</a></th>
    </tr>
ENDHTML;
